...
import no.ntnu.idata2900.project.backend.RestTemplateResponseErrorHandler;
  ...
  public DataPoint fetchTargetValues(DataPoint dp) {
    ...
    if (res.getStatusCode() == HttpStatus.OK) {
      ...
      if (resBody != null) {
        ...
        this.vesselRepo.save(dp.getVessel());
      } else {
        logger.error("Prediction response body is invalid");
      }
    } else {
