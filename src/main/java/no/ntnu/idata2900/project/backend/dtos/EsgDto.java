 ...
 * This class encapsulates information about fish weight, CO2 emissions, and the ratio of CO2 per
 * kg of fish. It is used to transfer ESG-related data between different layers of the application.
 */
public class EsgDto {
  /**
