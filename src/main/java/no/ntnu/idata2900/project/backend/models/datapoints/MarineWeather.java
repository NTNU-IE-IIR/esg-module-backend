...
@Schema(
    description = "Marine weather entity representing marine weather data (waves and ocean "
                + "current) at a specific data point"
)
public class MarineWeather {
  ...
  /**
   * Setter for wind waves data.
   *
   * @param wwaves The specifiec wind waves
   */
