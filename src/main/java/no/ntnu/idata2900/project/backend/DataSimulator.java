...
import no.ntnu.idata2900.project.backend.services.datapoints.DataPointService;
...
public class DataSimulator implements ApplicationListener<ApplicationReadyEvent> {
  ...
  // Edit to enable/disable simulator
  ...
  /**
   * Starts the simulator whent the Spring Boot application starts. The simulator is only started
   * if the <code>ACTIVE</code> constant is set to <code>true</code>.
   */
