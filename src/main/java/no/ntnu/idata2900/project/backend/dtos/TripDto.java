...
public class TripDto {
  ...
  /**
   * Constructor for the TripDto class.
   *
   * @param dataPointDto       The specified data point DTO
   * @param fishingSessions    The specified collection of fishing sessions
   * @param fuelConsumed       The specified fuel consumed
   * @param targetFuelConsumed The specified target fuel consumed
   * @param totalDistance      The specified total distance traveled
   */
  public TripDto(
      DataPointDto dataPointDto,
      Set<FishingSession> fishingSessions,
      float fuelConsumed,
      float targetFuelConsumed,
      float totalDistance
  ) {
   ...
   *
   * @param dataPointDto The {@link DataPointDto} object containing relevant data to be associated
   *                     with the trip.
   */
